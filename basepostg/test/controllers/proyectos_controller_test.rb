...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post :create, proyecto: { alumno_id: @proyecto.alumno_id, fecha: @proyecto.fecha, titulo: @proyecto.titulo }
    end
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { alumno_id: @proyecto.alumno_id, fecha: @proyecto.fecha, titulo: @proyecto.titulo }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
